	...
	AFRAME.registerComponent('particle-system', {
	    ...
	    init: function() {
	        ...
	        this.presets['default'] = {
	            ...
	            texture: (this.data.texture!==''?this.data.texture:'/vendor/images/star2.png'),
	            randomize: false
	        };
	        ...
	        this.presets['dust'] = {
	            ...
	            texture: (this.data.texture!==''?this.data.texture:'/vendor/images/smokeparticle.png'),
	            randomize: false
	        };
	        ...
	        this.presets['rain'] = {
	            ...
	            duration: (this.data.duration!=0?this.data.duration:null),
	            particleCount: (this.data.particleCount!==0?this.data.particleCount:1000),
	            texture: (this.data.texture!==''?this.data.texture:'/vendor/images/raindrop.png'),
	            randomize: false
	        };
